        ...
        <div className="w-full md:w-5/12 bg-[#FFF6EC] p-8 md:p-14 lg:p-16 flex flex-col justify-between border-r border-[#F3D1BD]/30 h-full overflow-y-auto">
          <div className="space-y-12">
            <Link href="/" className="flex items-center gap-4 group cursor-pointer w-fit">
              <Image src="/images/LOGO-ICA.webp" alt="ICA Logo" width={60} height={60} className="object-contain group-hover:scale-105 transition-transform" />
              <div>
                ...
                <p className="text-[11px] text-[#7A6E65] font-medium">{isMember ? "Member Portal" : "Cattery Portal"}</p>
              </div>
            </Link>
            ...
            <div className="space-y-4 max-w-md min-h-[160px]">
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-[#231A14] leading-[1.2]">
                {isMember ? "Keanggotaan Anda, selalu dalam genggaman." : "Kelola Cattery resmi Anda bersama ICA."}
              </h1>
              <p className="text-xs md:text-sm text-[#7A6E65] leading-relaxed font-normal">
                {isMember ? "Pantau masa berlaku keanggotaan, daftar event, dan telusuri cattery resmi ICA dari satu akun." : "Daftarkan nama cattery, pantau status sertifikasi, dan ikuti pameran resmi FIFe / ICA."}
              </p>
            </div>
          </div>

          <div className="pt-10 text-[11px] text-[#7A6E65]">© {new Date().getFullYear()} Indonesian Cat Association</div>
        </div>
          ...
          <div className="max-w-[460px] w-full mx-auto space-y-6 my-auto">
            <div className="space-y-1.5 min-h-[70px]">
              <h2 className="text-2xl md:text-[28px] font-black tracking-tight text-[#231A14]">
                {isLogin ? `Masuk sebagai ${isMember ? "Member" : "Cattery"}` : `Daftar Akun ${isMember ? "Member" : "Cattery"}`}
              </h2>
              <p className="text-xs md:text-sm text-[#7A6E65]">
                {isLogin ? `Gunakan email yang terdaftar pada ${isMember ? "keanggotaan" : "cattery"} Anda.` : "Lengkapi data diri Anda untuk membuat akun baru."}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input type="email" placeholder="nama@email.com" className="w-full px-4 py-3 text-xs md:text-sm rounded-xl border border-[#E9E2DC] focus:outline-none focus:border-[#EE6B28] bg-white text-[#231A14]" />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input type="password" placeholder="••••••••" className="w-full px-4 py-3 text-xs md:text-sm rounded-xl border border-[#E9E2DC] focus:outline-none focus:border-[#EE6B28] bg-white text-[#231A14]" />
              </div>
