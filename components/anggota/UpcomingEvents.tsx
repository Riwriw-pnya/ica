      ...
      <div className="mt-3 space-y-2">
        {items.map((event) => (
          <Link
            ...
            className="hover-lift flex items-center gap-3 rounded-lg border border-[var(--color-ink-100)] p-2.5 hover:bg-gradient-to-b hover:from-white hover:to-[var(--color-brand-orange-50)]"
          >
