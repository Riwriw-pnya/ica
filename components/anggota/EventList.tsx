            ...
            <div className="flex shrink-0 items-center gap-2.5 pl-[68px] sm:pl-0">
              ...
              {isRegistrationOpen ? (
                <Link
                  ...
                  className="rounded-full px-5 py-2.5 text-[12px] font-semibold text-white transition hover:brightness-95 bg-gradient-to-b from-[#FFC299] to-[#EE6B28] font-bold
              shadow-[0_4px_12px_rg ba(238,107,40,0.25)] border-t border-[#FFE5D4]hover:-translate-y-0.5 active:translate-y-0.5 active:shadow-[0_2px_6px_rgba(0,0,0,0.15)] transition-all duration-150 cursor-pointer"
                >
                  Daftar ikut
                </Link>
              ) : (
