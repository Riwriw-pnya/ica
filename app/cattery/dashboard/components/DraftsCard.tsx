      ...
      <div className="p-5 sm:p-6 space-y-6">
        <div className="flex items-start sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <a href="/cattery/mating-reports">
            {/* Penyesuaian padding (px-3 py-1.5 di mobile, px-5 py-2 di desktop) dan penambahan whitespace-nowrap */}
        ...
        <div className="space-y-5 divide-y divide-[#f4efe9]">
            ...
            <div className="flex items-start justify-between gap-3 sm:gap-4">
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="font-bold text-xs sm:text-sm text-[#1a1513]">MR-2026-0147 · Rimba × Kirana</h3>
                  <span className="px-2 py-0.5 rounded-md bg-[#f4efe9] text-[#786c60] text-[10px] sm:text-[11px] font-semibold">Draft</span>
                </div>
          ...
          <div className="pt-5 space-y-3">
            <div className="flex items-start justify-between gap-3 sm:gap-4">
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="font-bold text-xs sm:text-sm text-[#1a1513]">MR-2026-0146 · Bagas × Sekar</h3>
                  <span className="px-2 py-0.5 rounded-md bg-[#f4efe9] text-[#786c60] text-[10px] sm:text-[11px] font-semibold">Draft</span>
                </div>
