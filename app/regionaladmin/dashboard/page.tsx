        ...
        <div className="space-y-6 max-w-7xl mx-auto">
            <div className="flex items-center justify-between rounded-2xl border border-[var(--color-brand-orange-300)]/70 bg-white p-5 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:shadow-md active:translate-y-0 active:shadow-xs">
                ...
                >
                    ...
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-[#fde8d7] bg-[#fff0e5] text-[#ee6b28]">
                    ...
                    {/* Sisi Kanan: Tombol Buka Approval (Dipisah ke luar div teks) */}
                    <div className="flex shrink-0 items-center gap-1.5 rounded-full px-4 py-2 text-xs font-bold text-[var(--color-brand-orange-700)]/80">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {/* Baru Masuk */}
                <Link 
                    href="/regionaladmin/applications?status=Baru"
                    className="relative rounded-2xl border border-[#efe9e2] bg-white p-5 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:shadow-md active:translate-y-0 active:shadow-xs flex flex-col justify-between cursor-pointer"
                >
                ...
                {/* Sedang Direview */}
                <Link 
                    href="/regionaladmin/applications?status=Sedang direview"
                    className="relative rounded-2xl border border-[#efe9e2] bg-white p-5 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:shadow-md active:translate-y-0 active:shadow-xs flex flex-col justify-between cursor-pointer"
                >
                    <div className="flex items-start justify-between">
                        <div>
                ...
                {/* Perlu Revisi */}
                <Link 
                    href="/regionaladmin/applications?status=Perlu revisi"
                    className="relative rounded-2xl border border-[#efe9e2] bg-white p-5 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:shadow-md active:translate-y-0 active:shadow-xs flex flex-col justify-between cursor-pointer"
                >
                    <div className="flex items-start justify-between">
                        <div>
                ...
                {/* Disetujui */}
                <Link 
                    href="/regionaladmin/applications?status=Disetujui"
                    className="relative rounded-2xl border border-[#efe9e2] bg-white p-5 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:shadow-md active:translate-y-0 active:shadow-xs flex flex-col justify-between cursor-pointer"
                >
                    <div className="flex items-start justify-between">
                        <div>
