...
export default function EventPage() {
  const [activeStep, setActiveStep] = useState<
    "list" | "checkout" | "payment" | "cat-register" | "submitted"
  >("list");
      ...
      <main className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-[#7E7267] leading-relaxed max-w-3xl">
                ...
                <span className="font-semibold text-[#1A1513]">Member</span>.
        ...
        {activeStep === "payment" && (
          <EventPaymentView
            ...
            onNext={() => setActiveStep("cat-register")}
          />
        )}

        {activeStep === "cat-register" && (
          <EventCatRegistrationView
            onNext={() => setActiveStep("submitted")}
          />
        )}

        {activeStep === "submitted" && (
          <EventCatSubmittedView
            onBackToEvent={() => setActiveStep("list")}
            onEditCatData={() => setActiveStep("cat-register")}
          />
        )}
      </main>
    </div>
